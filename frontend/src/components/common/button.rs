...
pub fn Button(
    ...
    let base_classes = "inline-flex items-center justify-center font-medium rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed";
    
    let variant_classes = match variant {
        ButtonVariant::Primary => "text-white bg-blue-600 hover:bg-blue-700 focus:ring-blue-500",
        ButtonVariant::Secondary => "text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 focus:ring-blue-500",
        ButtonVariant::Danger => "text-white bg-red-600 hover:bg-red-700 focus:ring-red-500",
        ButtonVariant::Success => "text-white bg-green-600 hover:bg-green-700 focus:ring-green-500",
    };
    ...
    let classes = format!("{} {} {} {}", base_classes, variant_classes, size_classes, width_class);
